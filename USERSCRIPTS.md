...
![Custom crankshaft userscript settings](./assets/docs/customsettings_screenshot.png)
...
```
![Finished custom settings example](./assets/docs/customsettings_finishedexample.png)
